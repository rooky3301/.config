...
class WttrApi:
    ...
    def _get_weather_icon(self):
        ...
        You can find codes at https://worldweatheronline.com/developer/api/docs/weather-icons.aspx
        ...
        if self._is_day():
            return codes.CODE_TO_ICON[weather_code].day
        return codes.CODE_TO_ICON[weather_code].night

    def get_weather_status(self, short):
        '''i3blocks uses pango to render the followin output into the desired icons'''
    ...
    def get_options():
        ...
        parser = OptionParser()
        parser.add_option('-f', '--fahrenheit', dest='fahrenheit',
                          action='store_true', default=False,
                          help='Report degrees in Fahrenheit')
