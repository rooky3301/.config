...
const pages = [
  { name: "Public Catalog", href: "#", current: false },
  {
    name: "TEMPORIZADOR DIGITAL A LED, MAGNÉTICO PARA COZINHA",
    href: "#",
    current: true,
  },
];
      ...
      <div className="bg-white px-4 py-5 sm:px-6">
        <div className="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
          <div className="ml-4 mt-2">
            <h3 className="text-2xl font-bold uppercase leading-8 text-gray-900">
              Temporizador digital a led, magnético para cozinha
            </h3>
            <nav className="ml-1 flex" aria-label="Breadcrumb">
              <ol role="list" className="flex items-center space-x-1">
                <li>
                  <div>
                    <a
                      href="#"
                      className="text-sm font-normal leading-none text-gray-500"
                    >
                      <span>Produto</span>
                    </a>
                  </div>
          ...
          <div className="ml-4 mt-4 flex-shrink-0">
            <button
              type="button"
              className="relative inline-flex items-center rounded-md border border-solid border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-900 shadow-sm hover:bg-gray-100 focus:outline-none"
            >
              Voltar
            </button>
          </div>
