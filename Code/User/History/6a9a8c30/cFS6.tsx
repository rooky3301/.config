...
const navigation: NavigationItemProps[] = [
  { name: "Estatísticas Gerais", href: "/area_de_membros/", icon: ArrowTrendingUpIcon },
  { name: "Relatório de vendas", href: "/area_de_membros/SalesReport", icon: DocumentIcon },
  { name: "Financeiro", href: "/area_de_membros/finance", icon: FaRegMoneyBillAlt },
  { name: "Meus clientes", href: "/area_de_membros/clients", icon: UserGroupIcon },
  { name: "Meu Progresso", href: "/area_de_membros/progress", icon: ArrowUpRightIcon },
  { name: "Segurança", href: "/area_de_membros/security", icon: LockClosedIcon },
  { name: "Configurações", href: "/area_de_membros/settings", icon: Cog6ToothIcon },
];
